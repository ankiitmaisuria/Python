...
- Python runs on an interpreter system, meaning that code can be executed as soon as it is written.This means that prototying can be very quick.
- Python can be treated in a procedural way, an object-oriented way or functional way.
...
This is the exact stack many junior AI engineers use today.
...
- You can also write programms in text editor and save as .py which is python file extensions and run using command line using below command.
  ...
  12. [Functions](https://github.com/ankiitmaisuria/Python/tree/master/09_fuctions)
